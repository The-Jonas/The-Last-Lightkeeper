...
///
/// Fora do campo de visao do jogador a imagem fica MONOCROMATICA; dentro do
/// cone e do circulo dos pes a cor original volta por completo. A dessaturacao
/// real (luma = mistura dos tres canais) e impossivel com as chamadas normais
/// do SDL_Renderer, por isso esta classe usa um fragment shader de OpenGL.
///
